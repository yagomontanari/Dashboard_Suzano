...
- **Normalização de Layout (Aba Pagamentos)**: Implementação de layout ultra-compacto (High-Density). Hub reduzido para `140px` e Métricas para `120px`, com otimização tipográfica para aumentar a legibilidade (fontes e ícones ampliados internamente) sem expandir as dimensões dos cards.
