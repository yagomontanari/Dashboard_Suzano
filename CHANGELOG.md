...
- **Normalização de Layout (Aba Pagamentos)**: Otimização extrema do Hub. Remoção da métrica redundante "Volume Processado" e redução da largura do card para apenas 1 coluna (`lg:col-span-1`). Isso elimina espaços vazios, concentrando o foco na **Eficiência Financeira** e no indicador de **Meta**, mantendo a estética ultra-clean e compacta para dispositivos desktop.
