...
- **Relatórios**: Refinamento do layout de erros ZAJU, removendo colunas técnicas (`numov_integracao` e `numfat_integracao`) do relatório consolidado e da visualização em tela, focando em informações de negócio.
