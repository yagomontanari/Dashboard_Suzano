...
- **Normalização de Layout (Aba Pagamentos)**: Aplicação do sistema de alinhamento "Grid Shelf" e bordas `rounded-xl` em todos os cards de métricas de pagamento, garantindo paridade estética com o módulo ZAJU.
